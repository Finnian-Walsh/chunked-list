...
namespace chunked_list {
  ...
  ChunkedList<T, ChunkSize>::GenericIterator<ChunkT, ValueT>::GenericIterator(
    ChunkT *chunkPtr, const size_t index)
  ...
  template<typename ChunkT, typename ValueT>
  ChunkedList<T, ChunkSize>::GenericIterator<ChunkT, ValueT>::GenericIterator(
    ChunkT &chunkRef, const size_t index)
  ...
  template<typename T, size_t ChunkSize>
  template<typename ChunkT, typename ValueT>
  typename ChunkedList<T, ChunkSize>::template GenericIterator<ChunkT, ValueT> ChunkedList<T
    , ChunkSize>::GenericIterator<
  ...
  bool ChunkedList<T, ChunkSize>::GenericIterator<ChunkT, ValueT>::operator
  ==(const IteratorT other) const {
  ...
  template<typename T, size_t ChunkSize>
  template<typename ChunkT, typename ValueT>
  typename ChunkedList<T, ChunkSize>::template GenericIterator<ChunkT, ValueT>::ChunkIteratorT
  ...
  bool ChunkedList<T, ChunkSize>::GenericChunkIterator<ChunkT>::operator==(
    const ChunkIteratorT other) const {
    static_assert(utility::is_generic_chunk_iterator<ChunkedList, ChunkIteratorT>,
                  "ChunkIteratorT must be a GenericChunkIterator!");
    return chunk == &*other;
  }
